  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between lg:w-1/2 w-full lg:h-24 h-20 lg:26 items-center gap-4 left-0 bg-blue-50">
      {/* <div className="flex flex-1 space-x-2 hidden:border-r md:border-gray-300 h-12 w-full items-center ml-5">
        ...
        <span className="text-sm lg:text-md mt-1">Cash on Delivery</span>
      </div>
      <div className="flex-1 px-5 flex lg:px-10 items-center justify-between bg-white lg:bg-blue-50 lg w-full h-10 border-t border-b border-gray-200 lg:border-none">
        <div className="flex space-x-2 items-center lg:hidden">
          <img src="https://mcdn.coolmate.me/image/March2024/voucher-logo-mb.png" alt="" className="w-4 h-4" />
          <span>Voucher</span>
        </div>
...
export default FooterCartPayment;
